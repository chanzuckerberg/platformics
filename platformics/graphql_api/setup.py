...
def get_app(settings: APISettings, schema: strawberry.Schema, db_module: typing.Any, dependencies: typing.Optional[typing.Sequence[Depends]] = [], app: typing.Optional[FastAPI] = None) -> FastAPI:
    """
    ...
    _app = app if app else FastAPI(title=title, debug=settings.DEBUG, dependencies=dependencies)
